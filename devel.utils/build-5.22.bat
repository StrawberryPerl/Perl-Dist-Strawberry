...
rem perl -Mblib ..\script\perldist_strawberry -job ..\share\64bit-5.22.1.3.pp -test_core -beta=0 -perl_ldouble -app_simplename=strawberry-PDL-ld -nointeractive -norestorepoints -wixbin_dir=z:\sw\Wix38 -cpan_url file:///z:/_cpan-mirror/
