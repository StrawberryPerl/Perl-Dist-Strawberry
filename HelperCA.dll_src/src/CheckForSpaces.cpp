...
// ##### EXPORTED FUCTIONS: CheckForSpaces
	                   ...
	                   // Passed to most other routines.
{
	...
	RETURN_ON_ERROR(uiAnswer, hModule, _T("ERROR: CheckForSpaces - MsiGetProperty[WIXUI_INSTALLDIR_VALID] FAILED"));
	...
	RETURN_ON_ERROR(uiAnswer, hModule, _T("ERROR: CheckForSpaces - MsiGetProperty[INSTALLDIR] FAILED"));
