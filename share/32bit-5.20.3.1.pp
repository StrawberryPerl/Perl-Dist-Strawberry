...
{
  app_version     => '5.20.3.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 32,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libopenssl'    => '<package_url>/kmx/32_libs/gcc48-2015Q3/32bit_openssl-1.0.2d-bin_20150710.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
            ...
            { module=>'IO::Stringy', ignore_testfailure=>1 }, #XXX
            ...
            qw/ CPAN::SQLite FCGI /,
            qw/ IO::String /, #XXX IO::Stringy see above
...
##    },
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
          ...
          '<package_url>/kmx/perl-modules-patched/PDL-Stats-0.72_patched.tar.gz',
          '<package_url>/kmx/perl-modules-patched/Prima-1.44_patched.tar.gz',
          qw/ PDL::LinearAlgebra PDL::Graphics::Prima /,
