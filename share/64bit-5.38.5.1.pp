...
{
  app_version     => '5.38.5.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'https://www.cpan.org/src/5.0/perl-5.38.5.tar.gz',
        ...
        patch => { #DST paths are relative to the perl src root
            ...
            #'<dist_sharedir>/perl-5.38/CVE-2025-40909_for_538.patch'    => '*',  #  included in perl 5.38.5
            'config_H.gc'                                 => {
                I_DBM  => 'define',
                I_GDBM => 'define',
                I_NDBM => 'define',
