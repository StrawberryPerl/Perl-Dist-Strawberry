...
{
  app_version     => '5.30.2.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'openssl'       => '<package_url>/kmx/64_libs/gcc83-2020Q1/64bit_openssl-1.1.1d-bin_20200207.zip',
