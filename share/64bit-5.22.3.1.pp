...
{
  app_version     => '5.22.3.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libopenssl'    => '<package_url>/kmx/64_libs/gcc49-2016Q4/64bit_openssl-1.0.2j-bin_20161014.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'http://search.cpan.org/CPAN/authors/id/S/SH/SHAY/perl-5.22.3-RC4.tar.gz',
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
          'DROLSKY/Params-Validate-1.26.tar.gz', #XXX-FIXME v1.25 is broken however cpanm is not able to find v1.26
