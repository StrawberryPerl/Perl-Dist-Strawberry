  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            #libs
            'libdb'         => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_db-6.0.20-bin_20140318.zip',
            ...
            'libgd'         => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_libXpm-3.5.11-bin_20140318.zip',
            'liblibXpm'     => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_libgd-2.1.0-bin_20140318.zip',
            'liblibiconv'   => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_libiconv-1.14-bin_20140318.zip',
            'liblibpng'     => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_libpng-1.6.9-bin_20140318.zip',
            'liblibssh2'    => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_libssh2-1.4.3-bin_20140318.zip',
            'liblibxml2'    => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_libxml2-2.9.1-bin_20140318.zip',
            'liblibxslt'    => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_libxslt-1.1.28-bin_20140318.zip',
            'libmpc'        => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_mpc-1.0.2-bin_20140318.zip',
            'libmpfr'       => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_mpfr-3.1.2-bin_20140318.zip',
            'libopenssl'    => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_openssl-1.0.1f-bin_20140318.zip',
            'libpostgresql' => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_postgresql-9.3.3-bin_20140318.zip',
            'libt1lib'      => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_t1lib-5.1.2-bin_20140318.zip',
            'libtiff'       => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_tiff-4.0.3-bin_20140318.zip',
            'libxz'         => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_xz-5.0.5-bin_20140318.zip',
            'libzlib'       => '<package_url>/kmx/32_libs/gcc47-2014Q1/32bit_zlib-1.2.8-bin_20140318.zip',
            #special cases
