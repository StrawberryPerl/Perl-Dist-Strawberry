  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libopenssl'    => '<package_url>/kmx/32_libs/gcc49-2016Q2/32bit_openssl-1.0.2h-bin_20160509.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'cfitsio'       => '<package_url>/kmx/32_libs/gcc49-2016Q2/32bit_cfitsio-3.38-bin_20160509.zip',
        },
    },
    ### NEXT STEP ###########################
    {
