...
{
  app_version     => '5.34.3.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'https://www.cpan.org/src/5.0/perl-5.34.3.tar.gz',
    ...
    ### NEXT STEP ###########################
    {
        plugin => 'Perl::Dist::Strawberry::Step::InstallModules',
        modules => [
            { #  needed for Win32::Exe
                module => 'XML::Simple', 
                env    => { MAKEFLAGS      => '', }, #  does not like parallel builds?
            },
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
            ...
            # { module=>'DBD::mysql' },  #  disable for 5.34 - needs mysql 8 
