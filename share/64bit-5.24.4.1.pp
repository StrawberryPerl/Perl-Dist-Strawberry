...
{
  app_version     => '5.24.4.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libopenssl'    => '<package_url>/kmx/64_libs/gcc49-2018Q2/64bit_openssl-1.0.2o-bin_20180406.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'http://cpan.metacpan.org/authors/id/S/SH/SHAY/perl-5.24.4-RC1.tar.gz',
