  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            #libs
            'bzip2'         => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_bzip2-1.0.6-bin_20150119.zip',
            'libdb'         => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_db-6.1.19-bin_20150119.zip',
            'libexpat'      => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_expat-2.1.0-bin_20150119.zip',
            'libfreeglut'   => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_freeglut-2.8.1-bin_20150119.zip',
            'libfreetype'   => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_freetype-2.5.5-bin_20150119.zip',
            'libgdbm'       => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_gdbm-1.11-bin_20150119.zip',
            'libgiflib'     => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_giflib-5.1.1-bin_20150119.zip',
            'libgmp'        => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_gmp-5.1.3-bin_20150119.zip',
            'libjpeg'       => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_jpeg-9a-bin_20150119.zip',
            'libgd'         => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_libXpm-3.5.11-bin_20150119.zip',
            'libffi'        => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_libffi-3.2.1-bin_20150119.zip',
            'liblibXpm'     => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_libgd-2.1.1-bin_20150119.zip',
            'liblibiconv'   => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_libiconv-1.14-bin_20150119.zip',
            'liblibpng'     => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_libpng-1.6.16-bin_20150119.zip',
            'liblibssh2'    => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_libssh2-1.4.3-bin_20150119.zip',
            'liblibxml2'    => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_libxml2-2.9.2-bin_20150119.zip',
            'liblibxslt'    => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_libxslt-1.1.28-bin_20150119.zip',
            'libmpc'        => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_mpc-1.0.2-bin_20150119.zip',
            'libmpfr'       => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_mpfr-3.1.2-bin_20150119.zip',
            'libopenssl'    => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_openssl-1.0.1l-bin_20150119.zip',
            'libpostgresql' => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_postgresql-9.4.0-bin_20150119.zip',
            'libt1lib'      => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_t1lib-5.1.2-bin_20150119.zip',
            'libtiff'       => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_tiff-4.0.3-bin_20150119.zip',
            'libxz'         => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_xz-5.2.0-bin_20150119.zip',
            'libzlib'       => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_zlib-1.2.8-bin_20150119.zip',
            #special cases
...
##    },
    ...
    ### NEXT STEP ###########################
    {
        ...
        plugin  => 'Perl::Dist::Strawberry::Step::BinaryToolsAndLibs',
        install_packages => {
            'fftw3'         => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_fftw-3.3.4-bin_20150119.zip',
            'gnuplot'       => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_gnuplot-4.6.6-bin_20150119.zip',
            'gsl'           => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_gsl-1.16-bin_20150119.zip',
            'hdf4'          => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_hdf-4.2.10-bin_20150119.zip',
            'hdf5'          => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_hdf5-1.8.14-bin_20150119.zip',
            'plplot'        => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_plplot-5.10.0-bin_20150119.zip',
            'proj'          => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_proj-4.8.0-bin_20150119.zip',
            'szip'          => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_szip-2.1-bin_20150119.zip',
            'talib'         => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_ta-lib-0.4.0-bin_20150119.zip',
            'netcdf'        => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_netcdf-4.3.2-bin_20150119.zip',
            'lapack'        => '<package_url>/kmx/64_libs/gcc48-2015Q1/64bit_lapack-3.5.0-bin_20150119.zip',
            #spec. tools
