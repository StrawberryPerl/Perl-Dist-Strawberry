...
{
  app_version     => '5.32.0.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'openssl'       => '<package_url>/kmx/64_libs/gcc83-2020Q3/64bit_openssl-1.1.1g-bin_20200712.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'http://cpan.metacpan.org/authors/id/X/XS/XSAWYERX/perl-5.32.0.tar.gz',
