  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libffi'        => '<package_url>/kmx/32_libs/gcc83-2019Q2/32bit_libffi-3.2.1-bin_20190522.zip',
            ...
            'openssl'       => '<package_url>/kmx/32_libs/gcc83-2019Q2/32bit_openssl-1.1.1b-bin_20190522.zip',
