  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'freeglut'      => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_freeglut-3.0.0-bin_20190522.zip',
            ...
            'libffi'        => '<package_url>/kmx/64_libs/gcc83-2019Q3/64bit_libffi-3.3-rc0-bin_20190718.zip',
            ...
            'openssl'       => '<package_url>/kmx/64_libs/gcc83-2019Q3/64bit_openssl-1.1.1c-bin_20190728.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
          ...
          ##{ module=>'PDL::Graphics::Prima', ignore_testfailure => 1 }, # does not compile with 5.30.1
