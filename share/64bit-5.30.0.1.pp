  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libffi'        => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libffi-3.2.1-bin_20190522.zip',
            ...
            'openssl'       => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_openssl-1.1.1b-bin_20190522.zip',
