...
{
  app_version     => '5.30.0.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            #libs
            'bzip2'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_bzip2-1.0.6-bin_20190513.zip',
            'db'            => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_db-6.2.38-bin_20190513.zip',
            'expat'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_expat-2.2.6-bin_20190513.zip',
            'fontconfig'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_fontconfig-2.13.1-bin_20190513.zip',
            'freeglut'      => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_freeglut-3.0.0-bin_20190513.zip',
            'freetype'      => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_freetype-2.10.0-bin_20190513.zip',
            'gdbm'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_gdbm-1.18-bin_20190513.zip',
            'giflib'        => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_giflib-5.1.9-bin_20190513.zip',
            'gmp'           => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_gmp-6.1.2-bin_20190513.zip',
            'graphite2'     => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_graphite2-1.3.13-bin_20190513.zip',
            'harfbuzz'      => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_harfbuzz-2.3.1-bin_20190513.zip',
            'jpeg'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_jpeg-9c-bin_20190513.zip',
            'libffi'        => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libffi-3.2.1-bin_20190513.zip',
            'libgd'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libgd-2.2.5-bin_20190513.zip',
            'liblibiconv'   => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libiconv-1.16-bin_20190513.zip',
            'libidn2'       => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libidn2-2.1.1-bin_20190513.zip',
            'liblibpng'     => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libpng-1.6.37-bin_20190513.zip',
            'liblibssh2'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libssh2-1.8.2-bin_20190513.zip',
            'libunistring'  => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libunistring-0.9.10-bin_20190513.zip',
            'liblibxml2'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libxml2-2.9.9-bin_20190513.zip',
            'liblibXpm'     => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libXpm-3.5.12-bin_20190513.zip',
            'liblibxslt'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libxslt-1.1.33-bin_20190513.zip',
            'mpc'           => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_mpc-1.1.0-bin_20190513.zip',
            'mpfr'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_mpfr-4.0.2-bin_20190513.zip',
            'openssl'       => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_openssl-1.1.1b-bin_20190513.zip',
            'postgresql'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_postgresql-11.3-bin_20190513.zip',
            'readline'      => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_readline-8.0-bin_20190513.zip',
            't1lib'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_t1lib-5.1.2-bin_20190513.zip',
            'termcap'       => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_termcap-1.3.1-bin_20190513.zip',
            'tiff'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_tiff-4.0.10-bin_20190513.zip',
            'xz'            => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_xz-5.2.4-bin_20190513.zip',
            'zlib'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_zlib-1.2.11-bin_20190513.zip',
            #special cases
    ...
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'gnuplot'       => '<package_url>/kmx/64_libs/gcc71-2017Q2/64bit_gnuplot-5.0.6-bin_20170517.zip',
            ...
            'cfitsio'       => '<package_url>/kmx/64_libs/gcc71-2018Q4/64bit_cfitsio-3.45-bin_20181113.zip',
        },
    },
    ### NEXT STEP ###########################
    {
