...

{
  ...
  build_job_steps => [
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'http://search.cpan.org/CPAN/authors/id/C/CO/CORION/perl-5.17.10.tar.gz',
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
            ...
            '<package_url>/kmx/perl-modules-patched/Crypt-OpenSSL-EC-0.3_patched.tar.gz',       #XXX-TODO: OpenSSL detection
            'Crypt-OpenSSL-RSA',
            ...
            '<package_url>/kmx/perl-modules-patched/Crypt-Twofish-2.15_patched.tar.gz',         #XXX-TODO: 5.18.x incompatibility
            '<package_url>/kmx/perl-modules-patched/Crypt-DES-2.05_patched.tar.gz',             #XXX-TODO: 5.18.x incompatibility
            '<package_url>/kmx/perl-modules-patched/Class-ErrorHandler-0.01_patched.tar.gz',    #XXX-TODO: required by Convert-PEM
