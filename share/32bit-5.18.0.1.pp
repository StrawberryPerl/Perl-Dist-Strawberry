  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libpostgresql' => '<package_url>/kmx/32_libs/gcc46-2013Q2/32bit_postgresql-9.2.4-bin_20130515.zip',
            ...
            'libzlib'       => '<package_url>/kmx/32_libs/gcc46-2013Q2/32bit_zlib-1.2.8-bin_20130515.zip',
            #special cases
