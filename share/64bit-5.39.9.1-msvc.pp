...
{
  app_version     => '5.39.9.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  app_fullname    => 'Strawberry Perl (64-bit)',
  app_simplename  => 'strawberry-perl',
  maketool        => 'nmake', # 'dmake' or 'gmake'
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            # libreadline => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/dev_gcc13.1_20230606/64bit_readline-8.2-bin_20230606.zip',
            # libwebp => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/dev_gcc13.1_20230606/64bit_libwebp-1.3.2-bin_20231211.zip',
            # libfontconfig => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/dev_gcc13.1_20230606/64bit_fontconfig-2.13.1-bin_20230606.zip',
            # libfribidi => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/dev_gcc13.1_20230606/64bit_fribidi-1.0.12-bin_20230606.zip',
            # libgdbm => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/dev_gcc13.1_20230606/64bit_gdbm-1.19-bin_20230606.zip',
            # freeglut => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/dev_gcc13.1_20230606/64bit_freeglut-3.4.0-bin_20230606.zip',
            # libiidn => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/dev_gcc13.1_20230606/64bit_libidn2-2.1.1-bin_20230606.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'https://www.cpan.org/src/5.0/perl-5.39.9.tar.gz',  
        #url        => 'https://cpan.metacpan.org/authors/id/P/PE/PEVANS/perl-5.39.9.tar.gz',
        ...
        patch => { #DST paths are relative to the perl src root
            ...
            # '<dist_sharedir>/perl-5.38/Makefile'      => 'win32/GNUmakefile',
            '<dist_sharedir>/perl-5.39/Makefile.patch' => 'win32/Makefile',
            'config_H.gc'                                 => {
                I_DBM  => 'define',
                I_GDBM => 'define',
                I_NDBM => 'define',
