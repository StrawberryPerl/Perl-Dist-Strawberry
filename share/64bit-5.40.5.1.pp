...
{
  app_version     => '5.40.5.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'gmp'           => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/gcc13.2_ucrt_posix/64bit_gmp-6.3.0-bin_20250121.zip',
            ...
            'jpeg'          => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/gcc13.2_ucrt_posix/64bit_jpeg-9f-bin_20250530.zip',
            ...
            'openssl'       => 'https://github.com/StrawberryPerl/build-extlibs/releases/download/gcc13.2_ucrt_posix/64bit_openssl-3.6.1-bin_20260402.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'https://www.cpan.org/src/5.0/perl-5.40.5.tar.gz',
        cf_email   => 'strawberry-perl@project', #IMPORTANT: keep 'strawberry-perl' before @
        perl_debug => 0,    # can be overridden by --perl_debug=N option
        perl_64bitint => 1, # ignored on 64bit, can be overridden by --perl_64bitint | --noperl_64bitint option
        #  build core using these OPTIMIZE flags
        optimize_core => '-Os -falign-functions -falign-jumps -falign-labels -falign-loops -freorder-blocks -freorder-blocks-algorithm=stc -freorder-blocks-and-partition -fno-ident',
    ...
    ### NEXT STEP ###########################
    {
        ...
        exceptions => [
          ...
          { do=>'skip', distribution=>qr/^ExtUtils-/ }, #  issues with EU::ParseXS upgrade, possibly also EUMM #291
        ]
    },
    ### NEXT STEP ###########################
    {
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
            ...
            #  https://github.com/StrawberryPerl/Perl-Dist-Strawberry/issues/92  #  should be fixed now
    ...
    ### NEXT STEP ###########################
    {
        plugin => 'Perl::Dist::Strawberry::Step::InstallModules',
        modules => [
            # crypto related - many were disabled as CryptX 0.085 was failing - should be fixed in 0.086.
            ...
            qw /Math::Prime::Util/,
            'Alt::Crypt::RSA::BigInt',  #hack Crypt-RSA without Math::PARI - https://metacpan.org/release/Crypt-RSA, #  was failing for 5.40.1 due to Math::Prime::Util::GMP
            
            qw /Crypt::DSA::GMP/,  #  failed for 5.40.1 due to Math::Prime::Util::GMP

            qw/ Bytes::Random::Secure /,
            qw /Crypt::OpenPGP/,  #  failed for 5.40.1 due to Math::Prime::Util::GMP
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
            # graphics
            { module=>'GD', env=>{ 'HARNESS_SUBCLASS'=>'TAP::Harness::Restricted', 'HARNESS_SKIP'=>'t/security_open.t' } }, # https://github.com/lstein/Perl-GD/issues/69
    ...
    ### NEXT STEP ###########################
    {
        ...
        #  skip the minicpan tests due to what appear to be connection issues on the build machine
        modules => [ { module=>'Portable', env=>{ 'HARNESS_SUBCLASS'=>'TAP::Harness::Restricted', 'HARNESS_SKIP'=>'t/05_minicpan.t' } } ],
    },
    ### NEXT STEP ###########################
    {
