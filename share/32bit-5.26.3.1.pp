...
{
  app_version     => '5.26.3.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 32,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libopenssl'    => '<package_url>/kmx/32_libs/gcc71-2018Q4/32bit_openssl-1.1.0i-bin_20181113.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'http://cpan.metacpan.org/authors/id/S/SH/SHAY/perl-5.26.3.tar.bz2',
    ...
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'cfitsio'       => '<package_url>/kmx/32_libs/gcc71-2018Q4/32bit_cfitsio-3.45-bin_20181113.zip',
        },
    },
    ### NEXT STEP ###########################
    {
