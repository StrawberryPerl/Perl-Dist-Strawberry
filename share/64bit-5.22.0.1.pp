  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            'libgdbm'       => '<package_url>/kmx/64_libs/gcc49-2015Q2/64bit_gdbm-1.11-bin_20150519.zip',
            ...
            'libopenssl'    => '<package_url>/kmx/64_libs/gcc49-2015Q2/64bit_openssl-1.0.2a-bin_20150519.zip',
