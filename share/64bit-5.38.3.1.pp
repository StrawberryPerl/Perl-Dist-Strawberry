...
{
  app_version     => '5.38.3.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'https://www.cpan.org/src/5.0/perl-5.38.3.tar.gz',
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
          ...
          # Modules no longer in PDL Core but which were in the previous release
          qw /
              ...
              PDL::Graphics::Limits
          /,
          #  Newly non-core modules that were not installed for this release.  Listed only for info.
