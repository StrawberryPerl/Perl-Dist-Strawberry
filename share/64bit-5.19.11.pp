...
{
  app_version     => '5.19.11.3', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            #libs
            'libdb'         => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_db-6.0.30-bin_20140502.zip',
            'libexpat'      => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_expat-2.1.0-bin_20140502.zip',
            'libfreeglut'   => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_freeglut-2.8.1-bin_20140502.zip',
            'libfreetype'   => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_freetype-2.5.3-bin_20140502.zip',
            'libgdbm'       => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_gdbm-1.10-bin_20140502.zip',
            'libgiflib'     => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_giflib-5.0.6-bin_20140502.zip',
            'libgmp'        => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_gmp-5.1.3-bin_20140502.zip',
            'libjpeg'       => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_jpeg-9a-bin_20140502.zip',
            'libgd'         => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_libXpm-3.5.11-bin_20140502.zip',
            'liblibXpm'     => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_libgd-2.1.0-bin_20140502.zip',
            'liblibiconv'   => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_libiconv-1.14-bin_20140502.zip',
            'liblibpng'     => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_libpng-1.6.10-bin_20140502.zip',
            'liblibssh2'    => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_libssh2-1.4.3-bin_20140502.zip',
            'liblibxml2'    => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_libxml2-2.9.1-bin_20140502.zip',
            'liblibxslt'    => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_libxslt-1.1.28-bin_20140502.zip',
            'libmpc'        => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_mpc-1.0.2-bin_20140502.zip',
            'libmpfr'       => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_mpfr-3.1.2-bin_20140502.zip',
            'libopenssl'    => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_openssl-1.0.1g-bin_20140502.zip',
            'libpostgresql' => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_postgresql-9.3.4-bin_20140502.zip',
            'libt1lib'      => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_t1lib-5.1.2-bin_20140502.zip',
            'libtiff'       => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_tiff-4.0.3-bin_20140502.zip',
            'libxz'         => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_xz-5.0.5-bin_20140502.zip',
            'libzlib'       => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_zlib-1.2.8-bin_20140502.zip',
            #special cases
...
##    },
    ...
    ### NEXT STEP ###########################
    {
       ...
       commands => [ # files and dirs specific to portable edition
         ...
         { do=>'apply_tt',   args=>[ '<dist_sharedir>/portable/portable.perl.tt',       '<image_dir>/portable.perl', {gcchost=>'x86_64-w64-mingw32', gccver=>'4.8.2'} ] },
    ...
    ### NEXT STEP ###########################
    {
        plugin  => 'Perl::Dist::Strawberry::Step::BinaryToolsAndLibs',
        install_packages => {
            'fftw2'         => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_fftw-2.1.5-bin_20140502.zip',
            'fftw3'         => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_fftw-3.3.4-bin_20140502.zip',
            'gnuplot'       => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_gnuplot-4.6.5-bin_20140502.zip',
            'gsl'           => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_gsl-1.16-bin_20140502.zip',
            'hdf4'          => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_hdf-4.2.10-bin_20140502.zip',
            'hdf5'          => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_hdf5-1.8.12-bin_20140502.zip',
            'ncurses'       => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_ncurses-5.9-bin_20140502.zip',
            'plplot'        => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_plplot-5.10.0-bin_20140502.zip',
            'proj'          => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_proj-4.8.0-bin_20140502.zip',
            'szip'          => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_szip-2.1-bin_20140502.zip',
            'talib'         => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_ta-lib-0.4.0-bin_20140502.zip',
            'netcdf'        => '<package_url>/kmx/64_libs/gcc48-2014Q2/64bit_netcdf-4.3.2-bin_20140502.zip',
        },
    },
    ### NEXT STEP ###########################
    {
